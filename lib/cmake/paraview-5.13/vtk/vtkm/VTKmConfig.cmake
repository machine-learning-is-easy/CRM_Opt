...
if(CMAKE_CURRENT_LIST_DIR STREQUAL "D:/pv/rebuild/lib/cmake/paraview-5.13/vtk/vtkm")
  set(VTKm_PACKAGE_IN_BUILD TRUE)
endif()

if(VTKm_PACKAGE_IN_BUILD)
  set_and_check(VTKm_CMAKE_MODULE_PATH "D:/pv/ParaView/VTK/ThirdParty/vtkm/vtkvtkm/vtk-m/CMake")
else()
  set_and_check(VTKm_CMAKE_MODULE_PATH "${PACKAGE_PREFIX_DIR}/lib/cmake/paraview-5.13/vtk/vtkm/cmake")
endif()
...
set_and_check(VTKm_CONFIG_DIR "${PACKAGE_PREFIX_DIR}/lib/cmake/paraview-5.13/vtk/vtkm")
set(VTKM_FROM_INSTALL_DIR FALSE)
if(NOT "${CMAKE_BINARY_DIR}" STREQUAL "D:/pv/rebuild/VTK/ThirdParty/vtkm/vtkvtkm/vtk-m")
