...
function(check_file_hash has_hash hash_is_good)
  ...
  _ep_message_quiet_capture(STATUS "verifying file...
       file='D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz'")
  set(accumulated_output "${accumulated_output}" PARENT_SCOPE)

  file("MD5" "D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz" actual_value)

  if(NOT "${actual_value}" STREQUAL "bd946498e74229a65437a7952d4bcaf6")
    set("${hash_is_good}" FALSE PARENT_SCOPE)
    _ep_message_quiet_capture(STATUS "MD5 hash of
    D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz
  does not match expected value
    expected: 'bd946498e74229a65437a7952d4bcaf6'
      actual: '${actual_value}'")
    set(accumulated_output "${accumulated_output}" PARENT_SCOPE)
  else()
...
if("D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz" STREQUAL "")
  message(FATAL_ERROR "LOCAL can't be empty")
endif()

if("https://www.paraview.org/files/v5.12/ParaView-v5.12.0.tar.xz" STREQUAL "")
  message(FATAL_ERROR "REMOTE can't be empty")
endif()

function(download_and_verify)
  if(EXISTS "D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz")
...
"File already exists and hash match (skip download):
  file='D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz'
  MD5='bd946498e74229a65437a7952d4bcaf6'"
        )
        set(accumulated_output "${accumulated_output}" PARENT_SCOPE)
        return()
      else()
        ...
        set(accumulated_output "${accumulated_output}" PARENT_SCOPE)
        file(REMOVE "D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz")
      endif()
    else()
      _ep_message_quiet_capture(STATUS
...
Old file will be removed and new file downloaded from URL."
  ...
  _ep_message_quiet_capture(STATUS "Downloading...
   dst='D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz'
   timeout='none'
  ...
  foreach(i RANGE ${retry_number})
    ...
    foreach(url https://www.paraview.org/files/v5.12/ParaView-v5.12.0.tar.xz)
      if(NOT url IN_LIST skip_url_list)
        ...
        file(
          DOWNLOAD
          "${url}" "D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz"
...
set(extract_script D:/pv/pvsb/superbuild/paraview/tmp/extract-paraview.cmake)
