...
#
get_filename_component(filename "D:/pv/pvsb/downloads/ParaView-v5.12.0.tar.xz" ABSOLUTE)
get_filename_component(directory "D:/pv/pvsb/superbuild/paraview/src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-paraview${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-paraview${i}")
