...
class ContourLabelPluginPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/ContourLabelPluginPlugin")
#endif
public:
  ContourLabelPluginPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "ContourLabelPlugin"; }
  ...
  const char* GetDescription() override
    { return "Provide the 'Labeled Contour' representation for polydata datasets that represent contours."; }
