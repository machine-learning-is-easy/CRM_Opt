...
class NonOrthogonalSourcePlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/NonOrthogonalSourcePlugin")
#endif
public:
  ...
  const char* GetDescription() override
    { return "Non Orthogonal Source code sample"; }
