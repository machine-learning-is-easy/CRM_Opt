...
set_property(TARGET "NonOrthogonalSource::vtkNonOrthogonalSources" PROPERTY "INTERFACE_vtk_module_headers" "${_vtk_module_import_prefix}/include/paraview-5.13/ParaView_paraview_plugins/vtkShearedWaveletSource.h")
set_property(TARGET "NonOrthogonalSource::vtkNonOrthogonalSources" PROPERTY "INTERFACE_vtk_module_hierarchy" "${_vtk_module_import_prefix}/bin/paraview-5.13/plugins/NonOrthogonalSource/vtk/hierarchy/NonOrthogonalSource/vtkNonOrthogonalSources-hierarchy.txt")
