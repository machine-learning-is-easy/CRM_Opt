...
class ExplicitStructuredGridPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/ExplicitStructuredGridPlugin")
#endif
public:
  ExplicitStructuredGridPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "ExplicitStructuredGrid"; }
  ...
  const char* GetDescription() override
    { return "ExplicitStructuredGrid filters"; }
