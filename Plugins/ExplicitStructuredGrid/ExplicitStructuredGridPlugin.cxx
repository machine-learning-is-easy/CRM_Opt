#include "ExplicitStructuredGridPlugin.h"
...
#include "ExplicitStructuredGrid_qch.h"
...
namespace
{
  ...
  class ExplicitStructuredGridPluginCleaner
  {
  public:
    ExplicitStructuredGridPluginCleaner() = default;
    ~ExplicitStructuredGridPluginCleaner()
    {
      // The plugin library is being unloaded.
      // Let the plugin loader know so it doesn't try to unload it again.
      vtkPVPluginLoader::PluginLibraryUnloaded("ExplicitStructuredGrid");
    }
  } ExplicitStructuredGridPluginCleaner_Instance;
}

//-----------------------------------------------------------------------------
#if _paraview_add_plugin_SERVER_MANAGER_XML
#include "ExplicitStructuredGrid_server_manager.h"
#endif

#if _paraview_add_plugin_MODULES
#include "ExplicitStructuredGrid_server_manager_modules.h"
#include "ExplicitStructuredGrid_client_server.h"
#endif

//-----------------------------------------------------------------------------
void ExplicitStructuredGridPlugin::GetBinaryResources(
  std::vector<std::string>& resources)
{
  {
      const char *text = ExplicitStructuredGrid_qch();
...
ExplicitStructuredGridPlugin::GetInitializeInterpreterCallback()
{
#if _paraview_add_plugin_MODULES
  return ExplicitStructuredGrid_client_server_initialize;
#else
  return nullptr;
#endif
}
...
//-----------------------------------------------------------------------------
void ExplicitStructuredGridPlugin::GetXMLs(std::vector<std::string> &xmls)
{
  (void)xmls;
#if _paraview_add_plugin_SERVER_MANAGER_XML
  ExplicitStructuredGrid_server_manager_initialize(xmls);
#endif
#if _paraview_add_plugin_MODULES
  ExplicitStructuredGrid_server_manager_modules_initialize(xmls);
#endif
}
#endif
...
//-----------------------------------------------------------------------------
#if _paraview_add_plugin_with_ui
QObjectList ExplicitStructuredGridPlugin::interfaces()
{
  QObjectList ifaces;
...
void ExplicitStructuredGridPlugin::Initialize()
{
...
void ExplicitStructuredGridPlugin::GetPythonSourceList(std::vector<std::string>& modules,
...
//-----------------------------------------------------------------------------
static void initialize_ExplicitStructuredGrid_plugin_qt_resources()
{
#if !_paraview_add_plugin_built_shared && _paraview_add_plugin_with_resources
  ...
  Q_IMPORT_PLUGIN(ExplicitStructuredGridPlugin)
#endif
}

//-----------------------------------------------------------------------------
ExplicitStructuredGridPlugin::ExplicitStructuredGridPlugin()
{
  initialize_ExplicitStructuredGrid_plugin_qt_resources();
}

//-----------------------------------------------------------------------------
const char* ExplicitStructuredGridPlugin::GetEULA()
{
#if _paraview_add_plugin_EULA
  return ExplicitStructuredGrid_EULA;
#else
  return nullptr;
#endif
}
...
PV_PLUGIN_EXPORT(ExplicitStructuredGrid, ExplicitStructuredGridPlugin)
