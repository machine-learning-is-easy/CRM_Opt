...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/StereoCursorViewPlugin")
#endif
public:
  StereoCursorViewPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "StereoCursorView"; }
  ...
  const char* GetDescription() override
    { return "Render view displaying a 3D cursor widget"; }
