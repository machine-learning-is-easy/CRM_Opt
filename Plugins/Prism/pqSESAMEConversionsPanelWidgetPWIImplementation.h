...
#ifndef pqSESAMEConversionsPanelWidgetPWIImplementation_h
#define pqSESAMEConversionsPanelWidgetPWIImplementation_h

#include "pqPropertyWidgetInterface.h"
#include <QObject>

class pqSESAMEConversionsPanelWidgetPWIImplementation : public QObject, public pqPropertyWidgetInterface
{
  Q_OBJECT
...
private:
  Q_DISABLE_COPY(pqSESAMEConversionsPanelWidgetPWIImplementation)
};
