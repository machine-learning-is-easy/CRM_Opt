...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/PrismPlugin")
#endif
public:
  PrismPlugin();
  ...
  const char* GetDescription() override
    { return "A custom view and representations to visualize EOS (Equation of State) files, such as sesame, for multi physics simulations."; }
