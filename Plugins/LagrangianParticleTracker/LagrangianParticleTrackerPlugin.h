...
class LagrangianParticleTrackerPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/LagrangianParticleTrackerPlugin")
#endif
public:
  LagrangianParticleTrackerPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "LagrangianParticleTracker"; }
  ...
  const char* GetDescription() override
    { return "Highly customizable filter for particle tracking"; }
