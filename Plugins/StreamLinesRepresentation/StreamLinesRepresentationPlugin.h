...
class StreamLinesRepresentationPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/StreamLinesRepresentationPlugin")
#endif
public:
  StreamLinesRepresentationPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "StreamLinesRepresentation"; }
  ...
  const char* GetDescription() override
    { return "Add animated Stream Lines representation for any type of dataset"; }
