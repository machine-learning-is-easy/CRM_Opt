...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/GMVReaderPlugin")
#endif
public:
  GMVReaderPlugin();
  ...
  const char* GetDescription() override
    { return "Reader for binary or ASCII files stored in General Mesh Viewer file format"; }
