#include "DigitalRockPhysicsPlugin.h"
...
#include "DigitalRockPhysics_qch.h"
...
namespace
{
  ...
  class DigitalRockPhysicsPluginCleaner
  {
  public:
    DigitalRockPhysicsPluginCleaner() = default;
    ~DigitalRockPhysicsPluginCleaner()
    {
  ...
  } DigitalRockPhysicsPluginCleaner_Instance;
}

//-----------------------------------------------------------------------------
#if _paraview_add_plugin_SERVER_MANAGER_XML
#include "DigitalRockPhysics_server_manager.h"
#endif

#if _paraview_add_plugin_MODULES
#include "DigitalRockPhysics_server_manager_modules.h"
#include "DigitalRockPhysics_client_server.h"
#endif

//-----------------------------------------------------------------------------
void DigitalRockPhysicsPlugin::GetBinaryResources(
  std::vector<std::string>& resources)
{
  {
      const char *text = DigitalRockPhysics_qch();
...
DigitalRockPhysicsPlugin::GetInitializeInterpreterCallback()
{
#if _paraview_add_plugin_MODULES
  return DigitalRockPhysics_client_server_initialize;
#else
  return nullptr;
#endif
}
...
//-----------------------------------------------------------------------------
void DigitalRockPhysicsPlugin::GetXMLs(std::vector<std::string> &xmls)
{
  (void)xmls;
#if _paraview_add_plugin_SERVER_MANAGER_XML
  DigitalRockPhysics_server_manager_initialize(xmls);
#endif
#if _paraview_add_plugin_MODULES
  DigitalRockPhysics_server_manager_modules_initialize(xmls);
#endif
}
#endif
...
//-----------------------------------------------------------------------------
#if _paraview_add_plugin_with_ui
QObjectList DigitalRockPhysicsPlugin::interfaces()
{
  QObjectList ifaces;
...
void DigitalRockPhysicsPlugin::Initialize()
{
...
void DigitalRockPhysicsPlugin::GetPythonSourceList(std::vector<std::string>& modules,
...
//-----------------------------------------------------------------------------
static void initialize_DigitalRockPhysics_plugin_qt_resources()
{
#if !_paraview_add_plugin_built_shared && _paraview_add_plugin_with_resources
  ...
  Q_IMPORT_PLUGIN(DigitalRockPhysicsPlugin)
#endif
}

//-----------------------------------------------------------------------------
DigitalRockPhysicsPlugin::DigitalRockPhysicsPlugin()
{
  initialize_DigitalRockPhysics_plugin_qt_resources();
}

//-----------------------------------------------------------------------------
const char* DigitalRockPhysicsPlugin::GetEULA()
{
#if _paraview_add_plugin_EULA
...
PV_PLUGIN_EXPORT(DigitalRockPhysics, DigitalRockPhysicsPlugin)
