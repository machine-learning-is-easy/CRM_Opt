#include "DigitalSignalProcessingPlugin.h"
...
#include "DigitalSignalProcessing_qch.h"
...
namespace
{
  ...
  class DigitalSignalProcessingPluginCleaner
  {
  public:
    DigitalSignalProcessingPluginCleaner() = default;
    ~DigitalSignalProcessingPluginCleaner()
    {
      // The plugin library is being unloaded.
      // Let the plugin loader know so it doesn't try to unload it again.
      vtkPVPluginLoader::PluginLibraryUnloaded("DigitalSignalProcessing");
    }
  } DigitalSignalProcessingPluginCleaner_Instance;
}

//-----------------------------------------------------------------------------
#if _paraview_add_plugin_SERVER_MANAGER_XML
#include "DigitalSignalProcessing_server_manager.h"
#endif

#if _paraview_add_plugin_MODULES
#include "DigitalSignalProcessing_server_manager_modules.h"
#include "DigitalSignalProcessing_client_server.h"
#endif

//-----------------------------------------------------------------------------
void DigitalSignalProcessingPlugin::GetBinaryResources(
  std::vector<std::string>& resources)
{
  {
      const char *text = DigitalSignalProcessing_qch();
...
DigitalSignalProcessingPlugin::GetInitializeInterpreterCallback()
{
#if _paraview_add_plugin_MODULES
  return DigitalSignalProcessing_client_server_initialize;
#else
  return nullptr;
#endif
}
...
//-----------------------------------------------------------------------------
void DigitalSignalProcessingPlugin::GetXMLs(std::vector<std::string> &xmls)
{
  (void)xmls;
#if _paraview_add_plugin_SERVER_MANAGER_XML
  DigitalSignalProcessing_server_manager_initialize(xmls);
#endif
#if _paraview_add_plugin_MODULES
  DigitalSignalProcessing_server_manager_modules_initialize(xmls);
#endif
}
#endif
...
//-----------------------------------------------------------------------------
#if _paraview_add_plugin_with_ui
QObjectList DigitalSignalProcessingPlugin::interfaces()
{
  QObjectList ifaces;
...
void DigitalSignalProcessingPlugin::Initialize()
{
...
void DigitalSignalProcessingPlugin::GetPythonSourceList(std::vector<std::string>& modules,
...
//-----------------------------------------------------------------------------
static void initialize_DigitalSignalProcessing_plugin_qt_resources()
{
#if !_paraview_add_plugin_built_shared && _paraview_add_plugin_with_resources
  ...
  Q_IMPORT_PLUGIN(DigitalSignalProcessingPlugin)
#endif
}

//-----------------------------------------------------------------------------
DigitalSignalProcessingPlugin::DigitalSignalProcessingPlugin()
{
  initialize_DigitalSignalProcessing_plugin_qt_resources();
}

//-----------------------------------------------------------------------------
const char* DigitalSignalProcessingPlugin::GetEULA()
{
#if _paraview_add_plugin_EULA
  return DigitalSignalProcessing_EULA;
#else
  return nullptr;
#endif
}
...
PV_PLUGIN_EXPORT(DigitalSignalProcessing, DigitalSignalProcessingPlugin)
