...
class DigitalSignalProcessingPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/DigitalSignalProcessingPlugin")
#endif
public:
  DigitalSignalProcessingPlugin();
  ...
  const char* GetDescription() override
    { return "Digital Signal Processing Plugin : provides basic signal processing filters as well as an audio player dock."; }
