...
class AcceleratedAlgorithmsPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/AcceleratedAlgorithmsPlugin")
#endif
public:
  AcceleratedAlgorithmsPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "AcceleratedAlgorithms"; }
