...
namespace
{
  ...
  class MooseXfemClipPluginCleaner
  {
  public:
    MooseXfemClipPluginCleaner() = default;
    ~MooseXfemClipPluginCleaner()
    {
  ...
  } MooseXfemClipPluginCleaner_Instance;
}

//-----------------------------------------------------------------------------
#if _paraview_add_plugin_SERVER_MANAGER_XML
#include "MooseXfemClip_server_manager.h"
#endif

#if _paraview_add_plugin_MODULES
#include "MooseXfemClip_server_manager_modules.h"
#include "MooseXfemClip_client_server.h"
#endif

//-----------------------------------------------------------------------------
void MooseXfemClipPlugin::GetBinaryResources(
  std::vector<std::string>& resources)
{
  {
      const char *text = MooseXfemClip_qch();
...
MooseXfemClipPlugin::GetInitializeInterpreterCallback()
{
#if _paraview_add_plugin_MODULES
  return MooseXfemClip_client_server_initialize;
#else
  return nullptr;
#endif
}
...
//-----------------------------------------------------------------------------
void MooseXfemClipPlugin::GetXMLs(std::vector<std::string> &xmls)
{
  (void)xmls;
#if _paraview_add_plugin_SERVER_MANAGER_XML
  MooseXfemClip_server_manager_initialize(xmls);
#endif
#if _paraview_add_plugin_MODULES
  MooseXfemClip_server_manager_modules_initialize(xmls);
#endif
}
#endif
...
//-----------------------------------------------------------------------------
#if _paraview_add_plugin_with_ui
QObjectList MooseXfemClipPlugin::interfaces()
{
  QObjectList ifaces;
...
void MooseXfemClipPlugin::Initialize()
{
...
void MooseXfemClipPlugin::GetPythonSourceList(std::vector<std::string>& modules,
...
//-----------------------------------------------------------------------------
static void initialize_MooseXfemClip_plugin_qt_resources()
{
#if !_paraview_add_plugin_built_shared && _paraview_add_plugin_with_resources
  ...
  Q_IMPORT_PLUGIN(MooseXfemClipPlugin)
#endif
}

//-----------------------------------------------------------------------------
MooseXfemClipPlugin::MooseXfemClipPlugin()
{
  initialize_MooseXfemClip_plugin_qt_resources();
}

//-----------------------------------------------------------------------------
const char* MooseXfemClipPlugin::GetEULA()
{
#if _paraview_add_plugin_EULA
...
PV_PLUGIN_EXPORT(MooseXfemClip, MooseXfemClipPlugin)
