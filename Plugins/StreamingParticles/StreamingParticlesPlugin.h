...
class StreamingParticlesPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/StreamingParticlesPlugin")
#endif
public:
  StreamingParticlesPlugin();
  ...
  const char* GetDescription() override
    { return "Render Particles with Streaming"; }
