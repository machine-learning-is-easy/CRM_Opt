#include "StreamingParticlesPlugin.h"
...
#include "StreamingParticles_qch.h"
...
namespace
{
  ...
  class StreamingParticlesPluginCleaner
  {
  public:
    StreamingParticlesPluginCleaner() = default;
    ~StreamingParticlesPluginCleaner()
    {
  ...
  } StreamingParticlesPluginCleaner_Instance;
}

//-----------------------------------------------------------------------------
#if _paraview_add_plugin_SERVER_MANAGER_XML
#include "StreamingParticles_server_manager.h"
#endif

#if _paraview_add_plugin_MODULES
#include "StreamingParticles_server_manager_modules.h"
#include "StreamingParticles_client_server.h"
#endif

//-----------------------------------------------------------------------------
void StreamingParticlesPlugin::GetBinaryResources(
  std::vector<std::string>& resources)
{
  {
      const char *text = StreamingParticles_qch();
...
StreamingParticlesPlugin::GetInitializeInterpreterCallback()
{
#if _paraview_add_plugin_MODULES
  return StreamingParticles_client_server_initialize;
#else
  return nullptr;
#endif
}
...
//-----------------------------------------------------------------------------
void StreamingParticlesPlugin::GetXMLs(std::vector<std::string> &xmls)
{
  (void)xmls;
#if _paraview_add_plugin_SERVER_MANAGER_XML
  StreamingParticles_server_manager_initialize(xmls);
#endif
#if _paraview_add_plugin_MODULES
  StreamingParticles_server_manager_modules_initialize(xmls);
#endif
}
#endif
...
//-----------------------------------------------------------------------------
#if _paraview_add_plugin_with_ui
QObjectList StreamingParticlesPlugin::interfaces()
{
  QObjectList ifaces;
...
void StreamingParticlesPlugin::Initialize()
{
...
void StreamingParticlesPlugin::GetPythonSourceList(std::vector<std::string>& modules,
...
//-----------------------------------------------------------------------------
static void initialize_StreamingParticles_plugin_qt_resources()
{
#if !_paraview_add_plugin_built_shared && _paraview_add_plugin_with_resources
  ...
  Q_IMPORT_PLUGIN(StreamingParticlesPlugin)
#endif
}

//-----------------------------------------------------------------------------
StreamingParticlesPlugin::StreamingParticlesPlugin()
{
  initialize_StreamingParticles_plugin_qt_resources();
}

//-----------------------------------------------------------------------------
const char* StreamingParticlesPlugin::GetEULA()
{
#if _paraview_add_plugin_EULA
  return StreamingParticles_EULA;
#else
  return nullptr;
#endif
}
...
PV_PLUGIN_EXPORT(StreamingParticles, StreamingParticlesPlugin)
