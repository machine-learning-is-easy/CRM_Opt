...
class PanoramicProjectionViewPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/PanoramicProjectionViewPlugin")
#endif
public:
  PanoramicProjectionViewPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "PanoramicProjectionView"; }
  ...
  const char* GetDescription() override
    { return "Add a panoramic projection 3D view"; }
