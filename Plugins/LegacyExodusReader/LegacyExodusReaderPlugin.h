...
class LegacyExodusReaderPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/LegacyExodusReaderPlugin")
#endif
public:
  LegacyExodusReaderPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "LegacyExodusReader"; }
  ...
  const char* GetDescription() override
    { return "Legacy reader for Exodus files"; }
