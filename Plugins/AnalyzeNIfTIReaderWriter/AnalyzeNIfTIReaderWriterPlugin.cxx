...
#include "AnalyzeNIfTIReaderWriter_qch.h"
...
namespace
{
  ...
  class AnalyzeNIfTIReaderWriterPluginCleaner
  {
  public:
    AnalyzeNIfTIReaderWriterPluginCleaner() = default;
    ~AnalyzeNIfTIReaderWriterPluginCleaner()
    {
      // The plugin library is being unloaded.
      // Let the plugin loader know so it doesn't try to unload it again.
      vtkPVPluginLoader::PluginLibraryUnloaded("AnalyzeNIfTIReaderWriter");
    }
  } AnalyzeNIfTIReaderWriterPluginCleaner_Instance;
}

//-----------------------------------------------------------------------------
#if _paraview_add_plugin_SERVER_MANAGER_XML
#include "AnalyzeNIfTIReaderWriter_server_manager.h"
#endif

#if _paraview_add_plugin_MODULES
#include "AnalyzeNIfTIReaderWriter_server_manager_modules.h"
#include "AnalyzeNIfTIReaderWriter_client_server.h"
#endif

//-----------------------------------------------------------------------------
void AnalyzeNIfTIReaderWriterPlugin::GetBinaryResources(
  std::vector<std::string>& resources)
{
  {
      const char *text = AnalyzeNIfTIReaderWriter_qch();
...
AnalyzeNIfTIReaderWriterPlugin::GetInitializeInterpreterCallback()
{
#if _paraview_add_plugin_MODULES
  return AnalyzeNIfTIReaderWriter_client_server_initialize;
#else
  return nullptr;
#endif
}
...
//-----------------------------------------------------------------------------
void AnalyzeNIfTIReaderWriterPlugin::GetXMLs(std::vector<std::string> &xmls)
{
  (void)xmls;
#if _paraview_add_plugin_SERVER_MANAGER_XML
  AnalyzeNIfTIReaderWriter_server_manager_initialize(xmls);
#endif
#if _paraview_add_plugin_MODULES
  AnalyzeNIfTIReaderWriter_server_manager_modules_initialize(xmls);
#endif
}
#endif
...
//-----------------------------------------------------------------------------
#if _paraview_add_plugin_with_ui
QObjectList AnalyzeNIfTIReaderWriterPlugin::interfaces()
{
  QObjectList ifaces;
...
void AnalyzeNIfTIReaderWriterPlugin::Initialize()
{
...
void AnalyzeNIfTIReaderWriterPlugin::GetPythonSourceList(std::vector<std::string>& modules,
...
//-----------------------------------------------------------------------------
static void initialize_AnalyzeNIfTIReaderWriter_plugin_qt_resources()
{
#if !_paraview_add_plugin_built_shared && _paraview_add_plugin_with_resources
  ...
  Q_IMPORT_PLUGIN(AnalyzeNIfTIReaderWriterPlugin)
#endif
}
...
{
  initialize_AnalyzeNIfTIReaderWriter_plugin_qt_resources();
}

//-----------------------------------------------------------------------------
const char* AnalyzeNIfTIReaderWriterPlugin::GetEULA()
{
#if _paraview_add_plugin_EULA
  return AnalyzeNIfTIReaderWriter_EULA;
#else
  return nullptr;
#endif
}
...
PV_PLUGIN_EXPORT(AnalyzeNIfTIReaderWriter, AnalyzeNIfTIReaderWriterPlugin)
