...
class AnalyzeNIfTIReaderWriterPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/AnalyzeNIfTIReaderWriterPlugin")
#endif
public:
  ...
  const char* GetPluginName() override
    {return "AnalyzeNIfTIReaderWriter"; }
  ...
  const char* GetDescription() override
    { return "Reader/Writer for Analyze and NifTI files"; }
