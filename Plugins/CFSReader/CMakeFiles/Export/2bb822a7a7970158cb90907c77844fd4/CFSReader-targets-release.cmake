...
# Import target "CFSReader::Reader" for configuration "Release"
set_property(TARGET CFSReader::Reader APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(CFSReader::Reader PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/bin/paraview-5.13/plugins/CFSReader/vtkCFSReader.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::vtksys"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/paraview-5.13/plugins/CFSReader/vtkCFSReader.dll"
  )
