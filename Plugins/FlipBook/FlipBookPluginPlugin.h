...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/FlipBookPluginPlugin")
#endif
public:
  FlipBookPluginPlugin();
  ...
  const char* GetDescription() override
    { return "Add a new toolbar to perform flip book type rendering by switching visibility of the representations"; }
