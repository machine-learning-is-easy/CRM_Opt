...
#define _paraview_add_plugin_with_ui 1
#define _paraview_add_plugin_with_xml 0
...
class SaveStateAndScreenshotPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/SaveStateAndScreenshotPlugin")
#endif
public:
  SaveStateAndScreenshotPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "SaveStateAndScreenshot"; }
  ...
  const char* GetDescription() override
    { return "Saves the ParaView state and a screenshot without any user interaction"; }
