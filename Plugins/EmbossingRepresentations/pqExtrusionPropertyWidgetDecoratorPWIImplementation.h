...
#ifndef pqExtrusionPropertyWidgetDecoratorPWIImplementation_h
#define pqExtrusionPropertyWidgetDecoratorPWIImplementation_h

#include "pqPropertyWidgetInterface.h"
#include <QObject>

class pqExtrusionPropertyWidgetDecoratorPWIImplementation : public QObject, public pqPropertyWidgetInterface
{
  Q_OBJECT
  Q_INTERFACES(pqPropertyWidgetInterface)
public:
  pqExtrusionPropertyWidgetDecoratorPWIImplementation(QObject* parent);
  ~pqExtrusionPropertyWidgetDecoratorPWIImplementation() override;
...
private:
  Q_DISABLE_COPY(pqExtrusionPropertyWidgetDecoratorPWIImplementation)
};
