...
class ParametricSurfacesPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/ParametricSurfacesPlugin")
#endif
public:
  ParametricSurfacesPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "ParametricSurfaces"; }
  ...
  const char* GetDescription() override
    { return "Adds a ParametricSurfaces source"; }
