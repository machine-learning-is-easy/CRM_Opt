...
class BagPlotViewsAndFiltersPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/BagPlotViewsAndFiltersPlugin")
#endif
public:
  BagPlotViewsAndFiltersPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "BagPlotViewsAndFilters"; }
  ...
  const char* GetDescription() override
    { return "Bag Plot related views and filters"; }
