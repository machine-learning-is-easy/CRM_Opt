...
# Import target "LegacyGhostCellsGeneratorFilters" for configuration "Release"
set_property(TARGET LegacyGhostCellsGeneratorFilters APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(LegacyGhostCellsGeneratorFilters PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/bin/paraview-5.13/plugins/LegacyGhostCellsGenerator/LegacyGhostCellsGeneratorFilters.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::CommonCore;VTK::CommonDataModel;VTK::CommonMisc;VTK::ParallelCore"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/paraview-5.13/plugins/LegacyGhostCellsGenerator/LegacyGhostCellsGeneratorFilters.dll"
  )
