...
class LegacyGhostCellsGeneratorPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/LegacyGhostCellsGeneratorPlugin")
#endif
public:
  LegacyGhostCellsGeneratorPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "LegacyGhostCellsGenerator"; }
  ...
  const char* GetDescription() override
    { return "Legacy version of the Ghost Cells Generator restricted to vtkUnstructuredGrid input."; }
