...
class ThickenLayeredCellsPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/ThickenLayeredCellsPlugin")
#endif
public:
  ...
  const char* GetDescription() override
    { return "Filter to thicken layered cells"; }
